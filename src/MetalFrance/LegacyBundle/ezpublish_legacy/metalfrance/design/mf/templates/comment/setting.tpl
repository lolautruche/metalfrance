...
<div id="ezcom_setting">

<div class="user-edit mf-body">

    <p><a href={'/user/edit'|ezurl}>&laquo; {'Back'|i18n( 'ezcomments/comment/view/action' )}</a></p>
    <p>&nbsp;</p>
    ...
    {if is_set( $subscriber )|not()}
        <div class="message-error">
            <p>
                 {"Vous n'êtes abonné(e) à aucun fil de commentaires"|i18n( 'extension/metalfrance/user' )}
            </p>
        </div>
