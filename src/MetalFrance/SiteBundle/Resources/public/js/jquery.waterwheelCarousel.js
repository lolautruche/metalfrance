    ...
    $.fn.waterwheelCarousel = function (orientation, options) {
        ...
        return $(this).each(function () {
            ...
            function setupStarterRotation() {
                ...
                $(data.containerIDTag).trigger('change', currentPos);
            }
            ...
            function itemAnimationComplete($item, newPosition, direction) {
                ...
                if (data.itemsAnimating == 0) {
                    ...
                    // Otherwise there are no more rotations and...
                        ...
                        $(data.containerIDTag).trigger('change', data.items[0].data().currentPosition * -1);
                    }
                }
            }
            ...
            $('#coverflow_right').click(function (e) {
                rotateCarousel(false,1);
                e.preventDefault();
            });

            $('#coverflow_left').click(function (e) {
